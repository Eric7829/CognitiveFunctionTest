// Data for ISTP cognitive functions
const functionData = [
    {
        id: 'Ti',
        number: '01',
        label: 'Dominant', // ISTP Dominant is Ti
        heading: 'Ti',
    ...
    },
    {
        id: 'Se',
        number: '02',
        label: 'Auxiliary', // ISTP Auxiliary is Se
        heading: 'Se',
    ...
    },
    {
        id: 'Ni',
        number: '03',
        label: 'Tertiary', // ISTP Tertiary is Ni
        heading: 'Ni',
    ...
    },
    {
        id: 'Fe',
        number: '04',
        label: 'Inferior', // ISTP Inferior is Fe
        heading: 'Fe',
        body: 'Fe is your connection to the emotional environment and social expectations of others. While often less conscious, it represents a desire for harmonious relationships and a consideration for group feelings. Under stress, you might become acutely aware of social dynamics or feel a pull to connect with others emotionally. Developing this function involves learning to navigate social situations more smoothly and considering the impact of your actions on the feelings of those around you.',
        howToDevelop: 'Practice expressing appreciation for others, Consider the feelings of those around you in group settings, Participate in activities focused on helping others, Learn about social etiquette and dynamics.',
...
let currentFunctionIndex = 0; // Default to Ti (index 0 for ISTP)
